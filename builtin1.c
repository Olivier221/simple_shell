...
/**
 * _myhistory - displays the history list, one command by line, forward
 * With line numbers, starting from 0.
 * @info: A structure containing possible arguments. Used for maintenance
 * Continuous work prototype.
 * Returns: always 0
 */
